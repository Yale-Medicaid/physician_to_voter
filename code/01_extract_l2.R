...
tab_files <- list.files("../data/raw_l2", pattern = "*.tab", full.names=T, recursive = T)

output_folder_names <- gsub(".*Uniform--(.*).tab","../data/processed_voter_data/\\1",tab_files)
...
future_map2(tab_files, output_folder_names, transfer_to_parquets)