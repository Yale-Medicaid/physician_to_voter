...
* We match 180K
* Using a second LSH scheme which fuzzy matches first and last name with an exact match on middle initial gives us a total of 330K matches
...
# Match Statistics: Bayesian Method:

```{r, echo=F, results = "asis"}
data <- tar_read(augment_lsh_data)
data %>% select(
  full_name_sim, 
  mid_initial_agree, 
  zip_dist, 
